...
import {
  View, Text, TouchableOpacity, StyleSheet, TextInput, Platform, ToastAndroid, Image
} from 'react-native';
...
const REST_API_ENDPOINT = 'http://192.168.10.8:3000/users' || REST_API + "/users";
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        <View><Text style={{ fontSize: 22, fontWeight: 'bold', marginTop: 20, marginBottom: 5 }}>Create an account</Text>
          <Text style={{ color: '#AAAAAA' }}>Book your first shipment</Text></View>
